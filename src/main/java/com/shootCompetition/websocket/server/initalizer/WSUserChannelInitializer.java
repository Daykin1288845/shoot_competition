...
import com.shootCompetition.websocket.server.handler.UserConnectHandler;
import com.shootCompetition.websocket.server.handler.UserMessageHandler;
 ...
 */
public class WSUserChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    private void initHandles(SocketChannel ch) {
        ...
        ch.pipeline().addLast("ServerConnectHandler", new UserConnectHandler());
        ch.pipeline().addLast("WebSocketServerConnectHandler", new WebSocketServerConnectHandler());
        ch.pipeline().addLast("WebSocketServerMessageHandler", new UserMessageHandler());
